...
describe('StarredPackagesView', () => {
  ...
  it('creates snapshot', async () => {
    ...
    vi.mocked(API).getStarredByUser.mockResolvedValue(mockPackages);
  ...
  describe('Packages', () => {
    ...
    //   vi.mocked(API).getStarredByUser.mockResolvedValue(mockPackages).mockResolvedValueOnce({
    //     items: [],
    ...
    it('renders error message when getStarredByUser call fails with not unauthorized error', async () => {
      vi.mocked(API).getStarredByUser.mockRejectedValue({ kind: ErrorKind.Other });
    ...
    it('calls navigate to load login modal when user is not signed in', async () => {
      vi.mocked(API).getStarredByUser.mockRejectedValue({
