  ...
  },
  {
    ...
    input: {
      pkg: {
        ...
        version: '0.11.0',
        availableVersions: [
          { version: '0.6.0', createdAt: 1600841229 },
          { version: '0.5.0', createdAt: 1599125273 },
        ],
        appVersion: '0.11.0',
      ...
      sortedVersions: [{ version: '0.11.0', createdAt: 1607006504 }],
    },
    output: {
      methods: [
        {
  ...
  },
  {
    ...
    input: {
      pkg: {
        ...
        version: '1.0.1',
        availableVersions: [{ version: '1.0.1', createdAt: 1607672795 }],
        deprecated: false,
        signed: false,
        provider: 'Sysdig',
      ...
      sortedVersions: [{ version: '1.0.1', createdAt: 1607672795 }],
    },
    output: { methods: [{ label: 'cli', title: 'Helm CLI', kind: 5, props: { normalizedName: 'admin-activities' } }] },
  },
  {
    ...
    input: {
      pkg: {
        ...
        data: {},
        version: '1.0.0',
        availableVersions: [{ version: '1.0.0', createdAt: 1574121600 }],
        deprecated: false,
        license: 'Apache-2.0',
        signed: false,
        provider: 'Apache',
      ...
      sortedVersions: [{ version: '1.0.0', createdAt: 1574121600 }],
    },
    output: {
      methods: [
        {
  ...
  },
  {
    ...
    input: {
      pkg: {
        ...
        version: '1.0.0',
        availableVersions: [{ version: '1.0.0', createdAt: 1607672828 }],
        deprecated: false,
        signed: false,
        provider: 'IBM',
        hasValuesSchema: false,
      ...
      sortedVersions: [{ version: '1.0.0', createdAt: 1607672828 }],
      activeChannel: 'v1.0',
    },
    output: {
      methods: [
  ...
  },
  {
    ...
    input: {
      pkg: {
        ...
        version: '0.2.0',
        availableVersions: [
          { version: '0.2.0', createdAt: 1604681700 },
          { version: '0.1.1', createdAt: 1595186100 },
          { version: '0.1.0', createdAt: 1592590620 },
        ],
        deprecated: false,
        signed: false,
      ...
      methods: [
        {
          ...
          shortTitle: 'OLM CLI',
          kind: 3,
          props: { name: 'akka-cluster-operator', isGlobalOperator: true, activeChannel: 'alpha' },
        },
      ],
    },
  },
  ...
  },
  {
    ...
    input: {
      pkg: {
        ...
        version: '2.3.0',
        availableVersions: [
          { version: '2.3.0', createdAt: 1581321470 },
          { version: '1.0.0', createdAt: 1580368555 },
        ],
        deprecated: false,
        signed: false,
      ...
      methods: [
        {
          ...
          shortTitle: 'OLM CLI',
          kind: 3,
          props: { name: 'appranix', isGlobalOperator: false, activeChannel: 'deprecated' },
        },
      ],
    },
  },
  {
    ...
    input: {
      pkg: {
        ...
        version: '0.1.0',
        availableVersions: [{ version: '0.1.0', createdAt: 1595872800 }],
        deprecated: false,
        license: 'MIT',
        signed: false,
      ...
      sortedVersions: [{ version: '0.1.0', createdAt: 1595872800 }],
    },
    output: {
      methods: [
        {
