            ...
            <div className="d-flex align-items-start justify-content-between mb-3">
              <div className={`d-flex align-items-center flex-grow-1 ${styles.truncateWrapper}`}>
                <div className={`d-flex align-items-center justify-content-center overflow-hidden p-1 ${styles.imageWrapper}`}>
                  <Image imageId={props.package.logo_image_id} alt={`Logo ${props.package.display_name || props.package.name}`} className={styles.image} />
                </div>
                              ...
                              <div className="mr-2 text-truncate">
                                ...
                                <button
                                  ...
                                  onClick={(e) => {
                                    ...
                                    history.push({
                                      pathname: '/search',
                                      search: `?repo=${props.package.chart_repository.chart_repository_id}&page=1`,
                                      state: { fromSearchCard: true },
                                    });
                                  }}
                                >
                                  <u>{props.package.chart_repository.display_name || props.package.chart_repository.name}</u>
                                </button>
                              </div>
