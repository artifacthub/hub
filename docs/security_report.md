...
Trivy also scans [applications dependencies](https://aquasecurity.github.io/trivy/v0.18.3/vuln-detection/library/) for vulnerabilities. To do that, it inspects the files that contain the applications dependencies and the versions used.
