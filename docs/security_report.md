...
Trivy also scans [applications dependencies](https://trivy.dev/docs/v0.69/guide/coverage/language/) for vulnerabilities. To do that, it inspects the files that contain the applications dependencies and the versions used. Please see the [language-specific packages](https://trivy.dev/docs/v0.69/guide/coverage/language/) section in the Trivy documentation (image column) for a full list of the applications dependencies supported.
