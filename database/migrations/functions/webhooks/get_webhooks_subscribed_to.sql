-- get_webhooks_subscribed_to returns the webhooks subscribed to the event kind
-- and package provided.
create or replace function get_webhooks_subscribed_to(p_event_kind_id integer, p_package_id uuid)
