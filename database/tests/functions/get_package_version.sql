...
select is_empty(
    $$ select get_package_version('00000000-0000-0000-0000-000000000001'::uuid, '1.0.0') $$,
...
-- Package has just been seeded, request version 1.0.0 and 0.0.9
select is(
    get_package_version(:'package1ID'::uuid, '1.0.0')::jsonb,
    '{
    ...
    'Package is returned as a json object'
);
select is(
    get_package_version(:'package1ID'::uuid, '0.0.9')::jsonb,
    '{
        "package_id": "00000000-0000-0000-0000-000000000001",
        "kind": 0,
        "name": "package1",
