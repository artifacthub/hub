...
insert into repository (repository_id, name, display_name, url, repository_kind_id, user_id, last_tracking_errors)
values (:'repo1ID', 'repo1', 'Repo 1', 'https://repo1.com', 0, :'user1ID', 'error1\nerror2\n');
