...
select set_last_tracking_results(:'repo1ID', '');
...
select set_last_tracking_results(:'repo1ID', 'some errors');
...
-- Set last tracking results again with another same error and run some more tests
select set_last_tracking_results(:'repo1ID', 'some new errors');
